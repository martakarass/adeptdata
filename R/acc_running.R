#' @title Outdoor Run Raw Accelerometry Data
#'
#' @description Raw accelerometry data collected during 25 minutes of an
#' outdoor run. Data were collected at frequency 100 Hz simultaneously with
#' two wearable accelerometers located at left hip and left ankle.
#'
#' @format A \code{data.frame} with 300000 observations of 5 variables:
#' \itemize{
#'   \item \code{loc_id} - sensor location, one of: \code{"left_hip"}, \code{"left_ankle"},
...
#'
#' @details
#' Data were collected during 25 minutes of an
